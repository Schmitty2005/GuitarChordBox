...
type
  ...
  private
    ...
    procedure drawLines(aCanvas: TBGRACanvas; const aLinePoints: array of TstrRec);
    procedure drawXShape(aCanvas: TBGRACanvas; const aPoint: Tpoint);
    procedure drawOShape(aCanvas: TBGRACanvas; const aPoint: Tpoint);
    procedure DrawTriShape(aCanvas: TBGRACanvas; const aPoint: Tpoint);
    procedure DrawChordDataMarkers(aCanvas: TBGRACanvas);
...
procedure TChordBoxCanvasBGRA.drawLines(aCanvas: TBGRACanvas;
...
procedure TChordBoxCanvasBGRA.DrawTriShape(aCanvas: TBGRACanvas; const aPoint: Tpoint);
var
  markDot: Trect;
begin
...
procedure TChordBoxCanvasBGRA.DrawChordDataMarkers(aCanvas: TBGRACanvas);
var
...
procedure TChordBoxCanvasBGRA.drawXShape(aCanvas: TBGRACanvas; const aPoint: Tpoint);
const
  cRatio = 0.68;
var
  markDot: Trect;
...
procedure TChordBoxCanvasBGRA.drawOShape(aCanvas: TBGRACanvas; const aPoint: Tpoint);
var
  markDot: Trect;
  oldPen: integer;
begin
...
procedure TChordBoxCanvasBGRA.addMarker(aPoint: Tpoint; aCanvas: TBGRACanvas;
  txtLbl: string; aMarkerShape: TmarkerShape = msCircle);
...
function TChordBoxCanvasBGRA.DrawOnCanvas(aCanvas: TBGRACanvas): boolean;
var
  {$IFDEF FPC}
