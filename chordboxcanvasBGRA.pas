...
//
//WIP
//   -- Replaced TCanvas with TCanvasBGRA
...
type
  ...
  TChordBoxCanvasBGRA = class(TGuitarChordBoxCoOrds)
  private
    mPenWidth: integer;
    mManualPenWidth: integer;
    mAutoPenWidth: boolean;
    procedure drawLines(aCanvas: TCanvasBGRA; const aLinePoints: array of TstrRec);
    procedure drawXShape(aCanvas: TCanvasBGRA; const aPoint: Tpoint);
    procedure drawOShape(aCanvas: TCanvasBGRA; const aPoint: Tpoint);
    procedure DrawTriShape(aCanvas: TCanvasBGRA; const aPoint: Tpoint);
    procedure DrawChordDataMarkers(aCanvas: TCanvasBGRA);
  ...
  public
    ...
    procedure addMarker(aPoint: Tpoint; aCanvas: TCanvasBGRA; txtLbl: string;
      aMarkerShape: TmarkerShape = msCircle);
    function DrawOnCanvas(aCanvas: TCanvasBGRA): boolean;//@TODO move --see notes
...
procedure TChordBoxCanvasBGRA.drawLines(aCanvas: TCanvasBGRA;
...
procedure TChordBoxCanvasBGRA.DrawTriShape(aCanvas: TCanvasBGRA; const aPoint: Tpoint);
var
  markDot: Trect;
begin
...
procedure TChordBoxCanvasBGRA.DrawChordDataMarkers(aCanvas: TCanvasBGRA);
var
...
procedure TChordBoxCanvasBGRA.setautoPen(AValue: boolean);
begin
...
procedure TChordBoxCanvasBGRA.setMChordData(AValue: TChordData);
begin
...
procedure TChordBoxCanvasBGRA.setSixthStringFinger(AValue: TfretNumber);
begin
  mChordData.MarkerData[sixthString].Location :=
    aFingerPoints[Ord(SixthStrng), Ord(AValue)];
end;

procedure TChordBoxCanvasBGRA.setFifthStringFinger(AValue: TfretNumber);
begin
  mChordData.MarkerData[fifthString].Location :=
    aFingerPoints[Ord(fifthStrng), Ord(AValue)];
end;

procedure TChordBoxCanvasBGRA.setFourthStringFinger(AValue: TfretNumber);
begin
  mChordData.MarkerData[fourthString].Location :=
    aFingerPoints[Ord(fourthStrng), Ord(AValue)];
end;

procedure TChordBoxCanvasBGRA.setThirdStringFinger(AValue: TfretNumber);
begin
  mChordData.MarkerData[thirdString].Location :=
    aFingerPoints[Ord(thirdStrng), Ord(AValue)];
end;

procedure TChordBoxCanvasBGRA.setSecondStringFinger(AValue: TfretNumber);
begin
  mChordData.MarkerData[secondString].Location :=
    aFingerPoints[Ord(secondStrng), Ord(AValue)];
end;

procedure TChordBoxCanvasBGRA.setFirstStringFinger(AValue: TfretNumber);
begin
  mChordData.MarkerData[firstString].Location :=
    aFingerPoints[Ord(firstStrng), Ord(AValue)];
end;

procedure TChordBoxCanvasBGRA.drawXShape(aCanvas: TCanvasBGRA; const aPoint: Tpoint);
const
  cRatio = 0.68;
var
  markDot: Trect;
...
procedure TChordBoxCanvasBGRA.drawOShape(aCanvas: TCanvasBGRA; const aPoint: Tpoint);
var
  markDot: Trect;
  oldPen: integer;
begin
...
procedure TChordBoxCanvasBGRA.addMarker(aPoint: Tpoint; aCanvas: TCanvasBGRA;
...
{
procedure TChordBoxCanvasBGRA.addMarker(aString: TGuitarStrings;
  aFret: TFretNumber; aCanvas: TCanvasBGRA; txtLbl: string);
var
  DotSize: Trect;
  textLook: TTextStyle;
begin
...
function TChordBoxCanvasBGRA.DrawOnCanvas(aCanvas: TCanvasBGRA): boolean;
var
  {$IFDEF FPC}
...
begin
 ...
 {
procedure TChordBoxCanvasBGRA.DrawChordData(aChordData: TChordData);
begin
